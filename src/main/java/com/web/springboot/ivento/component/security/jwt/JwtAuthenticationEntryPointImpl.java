 ...
 * @author mokht
 *
 *         Implementation of AuthenticationEntryPoint interface class. This
 *         class responsibilities to handle unauthenticated User requests a
 *         secured HTTP resources and throw exception.
 *
 */
@Component
